...
public class OwnerRequestListAdapter extends ArrayAdapter<OwnerRequest> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((TextView) item.findViewById(R.id.peding_owner_request_club_name_textview)).setText(actualOwnerRequest.getClub().name);
		((TextView) item.findViewById(R.id.peding_owner_request_club_address_textview)).setText(actualOwnerRequest.getClub().address);
		((TextView) item.findViewById(R.id.peding_owner_request_user_name_textview)).setText(actualOwnerRequest.getUser().getNickname());
		((TextView) item.findViewById(R.id.peding_owner_request_user_email_textview)).setText(actualOwnerRequest.getUser().getEmail());
