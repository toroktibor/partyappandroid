...
public class ClubInfoModifyActivity extends ActionBarActivity implements SetServicesCommunicator {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clubServicesEditText.setText(SetServicesOfClubFragment.joinStrings(
                SetServicesOfClubFragment.tokenToName(selectedServices), ", "));
        ...
        clubModifyButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Session.getInstance().progressDialog = ProgressDialog.show(ClubInfoModifyActivity.this, "Kérlek várj",
                ...
                new NetThread(ClubInfoModifyActivity.this, new Runnable() {
                    ...
                    public void run() {
                        ...
                        Session.getInstance()
                                ...
                                .updateClubInfo(actualClub.id, actualClub.name, actualClub.type,
                                        actualClub.description, actualClub.address, actualClub.phonenumber,
                                        actualClub.email);
                        Session.getInstance().getActualCommunicationInterface()
                                .setServices(actualClub.id, selectedServices);
                        ...
                        ClubInfoModifyActivity.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                new DoneToast(ClubInfoModifyActivity.this, "Szórakozóhely adatai módosítva lettek!")
                                        .show();
