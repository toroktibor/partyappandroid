...
public class InternetConnection {
	...
	public static void checkConnection(final Context context, final InternetConnectionContinue ICContinue){
		...
		builder.setPositiveButton("Próbáld újra", new android.content.DialogInterface.OnClickListener() {
